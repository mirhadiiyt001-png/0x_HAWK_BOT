...
const COUNTRY_PREFIXES: string[] = [
  ...
  "1664","1670","1671","1684","1721","1758","1767","1784","1787","1868","1869","1876","1939",
  // 3-digit
  "350","351","352","353","354","355","356","357","358","359",
  "370","371","372","373","374","375","376","377","380","381","382","383","385","386","387","389",
  "420","421","423","500","501","502","503","504","505","506","507","509",
...
function flag(phone: string): string {
  ...
  const map: [string, string][] = [
    ...
    ["263","🇿🇼"],["264","🇳🇦"],["265","🇲🇼"],["266","🇱🇸"],["267","🇧🇼"],
    ["268","🇸🇿"],["269","🇰🇲"],
    // Kazakhstan (77/76 prefix — before generic +7 Russia)
    ["77","🇰🇿"],["76","🇰🇿"],
    // 2-digit codes
    ["30","🇬🇷"],["31","🇳🇱"],["32","🇧🇪"],["33","🇫🇷"],["34","🇪🇸"],
    ["36","🇭🇺"],["39","🇮🇹"],["40","🇷🇴"],["41","🇨🇭"],["43","🇦🇹"],
    ...
    ["90","🇹🇷"],["91","🇮🇳"],["92","🇵🇰"],["93","🇦🇫"],["94","🇱🇰"],
    ["95","🇲🇲"],["98","🇮🇷"],["20","🇪🇬"],["27","🇿🇦"],
    // 1-digit codes (must be last)
    ["7","🇷🇺"],["1","🇺🇸"],
  ];
  for (const [prefix, emoji] of map) {
