...
function buildStatsMessage(total: string, displayed: string, otps: number, sessionSms: number): string {
  return (
    ...
    `╰ ${ce("⚡️")} Refresh  →  <b>Every 5 seconds</b>\n` +
    `┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄`
  );
}
